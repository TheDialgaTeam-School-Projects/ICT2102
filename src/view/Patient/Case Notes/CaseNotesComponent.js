...
import {CaseNotesComponentController} from '../../../controller/Patient/Case Notes/CaseNotesComponent';

export class CaseNotesComponent extends Component {
  constructor(props) {
    super(props);
    this.controller = new CaseNotesComponentController(this);
  }
