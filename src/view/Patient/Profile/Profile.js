...
export class ProfileView extends Component {
  ...
  render() {
    const name = this.state.patientModel
      ? this.state.patientModel.getPatientName()
      : '';
    const id = this.state.patientModel
      ? this.state.patientModel.getPatientId()
      : '';
    const emergencyContact = this.state.patientModel
      ? this.state.patientModel.getPatientEmergencyContact()
      : '';
    const address = this.state.patientModel
      ? this.state.patientModel.getPatientAddress()
      : [];
    const photo = this.state.patientModel
      ? this.state.patientModel.getPhoto()
      : '';
    return (
      <Container>
